...
high_net_consumer_benefit <- high_gross_consumer_benefit - high_producer_benefit
low_net_consumer_benefit <- low_gross_consumer_benefit - low_producer_benefit
```
...
high_net_consumer_welfare_tax <- high_gross_consumer_welfare_tax - high_producer_benefit_tax - high_tax_total
low_net_consumer_welfare_tax <- low_gross_consumer_welfare_tax - low_producer_benefit_tax - low_tax_total
```
...
tax_fun <- function(t) {
  ...
  high_welfare_var <- integrate(high_demand,lower=0,upper=high_tax_curve_intersect_var)$value + redis_high - high_producer_welfare_var
  low_welfare_var <- integrate(low_demand,lower=0,upper=low_tax_curve_intersect_var)$value +redis_low -local_env_cost_tax_var- low_producer_welfare_var
