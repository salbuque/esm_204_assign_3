...
```{r}
# Producer welfare
producer_tax_welfare <- tax_price*agg_tax_curve_intersect - integrate(supply_tax,lower=0,upper=agg_tax_curve_intersect)$value
```
...
tax_fun <- function(t) {
  ...
  high_producer_welfare_var <- price_var*high_tax_curve_intersect_var-integrate(supply,lower=0,upper=high_tax_curve_intersect_var)$value  
  low_producer_welfare_var <- price_var*low_tax_curve_intersect_var-integrate(supply,lower=0,upper=low_tax_curve_intersect_var)$value  
  ...
  return(data.frame(tax=t,
                    ...
                    low_interset = low_tax_curve_intersect_var,
